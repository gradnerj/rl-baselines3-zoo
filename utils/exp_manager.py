...
class ExperimentManager(object):
    ...
    def __init__(
        ...
        val_env_kwargs: Optional[Dict[str, Any]] = None,
        trained_agent: str = "",
        ...
        self.val_env_kwargs = {} if env_kwargs is None else val_env_kwargs
    ...
    def create_envs(
        ...
        if eval_env and self.val_env_kwargs is not None:
            env_kwargs = self.env_kwargs
        else:
            env_kwargs = self.val_env_kwargs
        env = make_vec_env(
            env_id=self.env_id,
            n_envs=n_envs,
            seed=self.seed,
